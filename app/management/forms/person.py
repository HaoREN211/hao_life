...
class PersonCreateForm(RenderForm):
    ...
    nationality_id = SelectField("国籍", coerce=int, choices=[(0, "暂无")], default=0, render_kw={"class":"select-control"})
    birth_city_id = SelectField("出生城市", coerce=int, choices=[(0, "暂无")], default=0, render_kw={"class":"select-control"})
    origin_city_id = SelectField("籍贯城市", coerce=int, choices=[(0, "暂无")], default=0, render_kw={"class":"select-control"})
    constellation_id = SelectField("星座", coerce=int, choices=[(0, "暂无")], default=0, render_kw={"class":"select-control"})
    blood_group_id = SelectField("血型", coerce=int, choices=[(0, "暂无")], default=0, render_kw={"class":"select-control"})
